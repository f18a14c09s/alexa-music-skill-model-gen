...
import f18a14c09s.generation.alexa.music.data.AskMusicModelExampleAnalyzer;
...
//            classSimpleName.append("Test");
            ...
            try {
                retval.put(String.format("%sTest", className),
                        new AskMusicExampleBasedTestJavaGenerator().generateTestClass(classSimpleName.toString()
                                        .endsWith("Request") ?
